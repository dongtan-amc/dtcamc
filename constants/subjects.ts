...
export const SUBJECTS_SUBMENUS = [
  {
    ...
    contents: [
      ...
      },
      {
        ...
        description:
          "코부터 폐까지, 공기가 이동하는 통로에 위치하는 기관들이 모두 이에 해당합니다.<br/><br/>문제가 발생할 경우 기침, 콧물, 재채기, 빈호흡, 호흡곤란, 청색증 등의 증상을 보일 수 있습니다.<br/>원인으로는 가벼운 감기에서 부터 비염, 폐렴, 특정 소형견에서 다발하는 기도허탈 및 단두종호흡기증후군등이 있습니다.<br/><br/>노령동물의 경우 심장과 관련된 경우가 많기 때문에 항상 주의있는 관찰이 필요합니다.<br/>",
