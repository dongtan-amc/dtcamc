...
export default function MoreSection() {
  return (
    <Container>
      <div className="border-t flex flex-col items-center py-10">
        <div className="flex flex-col items-center gap-4">
          <p className="text-primary text-xl font-bold">{NAME}와 함께하세요!</p>
        ...
        <div className="my-10">
          <ul className="flex gap-10 justify-between">
            {MORES.map((more) => (
              <li key={more.title} className="flex flex-col items-center w-1/3">
