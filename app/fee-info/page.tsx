                        ...
                        <tbody>
                            {feeData.map((item, index) => (
                                ...
                                >
                                    ...
                                    {shouldShowCategory(index) && (
                                        <td
                                            className="border border-gray-300 px-3 py-3 text-xs text-gray-600 whitespace-pre-line align-top"
                                            rowSpan={getCategoryRowSpan(index)}
                                        >
